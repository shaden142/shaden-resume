...
Cybersecurity graduate from the University of Jeddah (GPA 4.9/5.0) and EC-Council Certified SOC Analyst (CSAv2), with a foundation in both offensive and defensive security — penetration testing, API security, cloud security, and SOC monitoring. Currently preparing for the Certified Ethical Hacker (CEH) certification.
...
### 🛠️ Tools & Platforms
`Kali Linux` `Burp Suite` `Nmap` `Splunk` `Wazuh` `Snort` `pfSense` `AWS` `Docker` `Python` `Wireshark` `Active Directory`
